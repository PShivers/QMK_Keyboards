...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FKEYSNUMPAD] = LAYOUT(KC_ESC, KC_F9, KC_F10, KC_F11, KC_F12, SELECTALL, KC_NO, KC_7, KC_8, KC_9, KC_PPLS, KC_DEL,
        ...
        KC_LSFT, KC_F1, KC_F2, KC_F3, KC_F4, LCTL(KC_SLSH), KC_NO, KC_1, KC_2, KC_3, KC_PAST, KC_NO,
...
bool process_record_user(uint16_t keycode, keyrecord_t* record) {
    ...
    case SELECTALL:
        ...
        break;
    case COMMENT:
        //this is the way to comment in Visual Studio 
        if (record->event.pressed) {
    ...
    case UNCOMMENT:
        //this is the way to uncomment in Visual Studio
        if (record->event.pressed) {
